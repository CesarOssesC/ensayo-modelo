...
class PreciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create precio" do
    assert_difference("Precio.count") do
      post precios_url, params: { precio: { nombre: @precio.nombre, precio_pesos: @precio.precio_pesos, precio_uf: @precio.precio_uf } }
    end
  ...
  test "should update precio" do
    patch precio_url(@precio), params: { precio: { nombre: @precio.nombre, precio_pesos: @precio.precio_pesos, precio_uf: @precio.precio_uf } }
